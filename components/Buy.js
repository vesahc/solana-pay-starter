...
export default function Buy({ itemID }) {
    ...
    const [item, setItem] = useState(null); // IPFS & filename of the purchased item
    const [loading, setLoading] = useState(false); // Loading state of all above
    const [paid, setPaid] = useState(STATUS.initial); // Tracking transaction status
    ...
    // Fetch the transation object from the server (done to avoid tampering)
